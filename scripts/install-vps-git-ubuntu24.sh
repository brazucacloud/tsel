...
# TSEL VPS Installation Script - Ubuntu 24.04+ Fixed
# Este script resolve definitivamente o problema do MongoDB em Ubuntu 24.04+
...
log "🚀 Iniciando instalação TSEL na VPS (Ubuntu 24.04+ Fixed)..."
...
# FIXED: MongoDB Installation for Ubuntu 24.04+ (FORCE MongoDB 7.0)
...
# FORCE MongoDB 7.0 for Ubuntu 24.04+
warning "Forçando instalação MongoDB 7.0 para Ubuntu 24.04+"

# Create keyring directory
mkdir -p /etc/apt/keyrings

# Add MongoDB 7.0 repository with proper keyring (FORCE for Ubuntu 24.04)
...
success "MongoDB 7.0 instalado para Ubuntu 24.04+"

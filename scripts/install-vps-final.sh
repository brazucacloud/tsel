...
# TSEL VPS Final Installation Script
...
log "🚀 Instalação final TSEL na VPS..."
...
# 1. Verificar se o diretório existe e remover se necessário
...
# 11. Verificar se moment foi instalado
...
# 13. Criar usuário de serviço se não existir
...
# 15. Criar systemd service se não existir
...
# 16. Testar moment antes de iniciar
log "🧪 Testando moment..."
if node -e "require('moment'); console.log('✅ moment funciona')"; then
...
# 17. Testar analytics route antes de iniciar
log "🧪 Testando analytics route..."
if node -e "require('./routes/analytics'); console.log('✅ analytics route funciona')"; then
    success "analytics route funciona corretamente"
else
    error "analytics route não funciona"
    exit 1
fi
...
# 19. Aguardar e verificar status
...
echo ""
success "🎉 Instalação final concluída com sucesso!"
echo ""
